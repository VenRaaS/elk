...
4. (optional, package updated) `./logstash-1.5.4/bin/plugin update logstash-input-lumberjack` update lumberjack plugin.(Ref: elk/wiki/Logstash-Configuration-for-Lumberjack-Input) 
